...
export class ProcessesComponentComponent implements OnInit {
  ...
  @Input()
  set processRequestEvent(processRequestEvent: modelp.ProcessRequestEvent) {
    console.log("ProcessesComponentComponent - procesprocessRequestEvent: "+JSON.stringify(processRequestEvent));
    this.processesService.getProcesses(processRequestEvent.processRequest).subscribe(
      p => {
        this.instances = p;
        this.data = p;
